...
"""autogenerated by genpy from omnimapper_msgs/NarfFeatures.msg. Do not edit."""
import sys
...
class NarfFeatures(genpy.Message):
  _md5sum = "875f7f5673c1d6fc8fe7b4aee13aa866"
  _type = "omnimapper_msgs/NarfFeatures"
...
float32[] descriptor
"""
  __slots__ = ['header','narfs','descriptors']
  _slot_types = ['std_msgs/Header','omnimapper_msgs/NarfFeature[]','omnimapper_msgs/NarfDescriptor[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NarfFeatures, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.narfs is None:
        self.narfs = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.narfs)
      buff.write(_struct_I.pack(length))
      for val1 in self.narfs:
        _v1 = val1.header
