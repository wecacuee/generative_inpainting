...
"""autogenerated by genpy from omnimapper_msgs/ObjectInfos.msg. Do not edit."""
import sys
...
class ObjectInfos(genpy.Message):
  _md5sum = "55e75559dd9c756f042c5681c2d3f1bf"
  _type = "omnimapper_msgs/ObjectInfos"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """ObjectInfo[] objects

================================================================================
MSG: omnimapper_msgs/ObjectInfo
Header header
...
"""
  __slots__ = ['objects']
  _slot_types = ['omnimapper_msgs/ObjectInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectInfos, self).__init__(*args, **kwds)
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_f().pack(val1.grasp_width))
        _v7 = val1.bbox_min
        _x = _v7
        buff.write(_get_struct_3f().pack(_x.x, _x.y, _x.z))
        _v8 = val1.bbox_max
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = omnimapper_msgs.msg.ObjectInfo()
        _v9 = val1.header
        start = end
        end += 4
        ...
        (_v12.is_dense,) = _get_struct_B().unpack(str[start:end])
        _v12.is_dense = bool(_v12.is_dense)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        (val1.grasp_width,) = _get_struct_f().unpack(str[start:end])
        _v15 = val1.bbox_min
        _x = _v15
        start = end
        end += 12
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v28.is_dense,) = _get_struct_B().unpack(str[start:end])
