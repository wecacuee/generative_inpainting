...
"""autogenerated by genpy from omnimapper_msgs/LabeledImage.msg. Do not edit."""
import sys
...
class LabeledImage(genpy.Message):
  _md5sum = "8e9d1bcb9481ffa95b6b1548dba9cbd1"
  _type = "omnimapper_msgs/LabeledImage"
...
sensor_msgs/Image false_color_image
...
bool do_rectify
"""
  __slots__ = ['transform','platform','image','info','labels','false_color_image']
  _slot_types = ['geometry_msgs/TransformStamped','string','sensor_msgs/Image','sensor_msgs/CameraInfo','sensor_msgs/Image','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       transform,platform,image,info,labels,false_color_image
    ...
    if args or kwds:
      ...
      if self.labels is None:
        self.labels = sensor_msgs.msg.Image()
      if self.false_color_image is None:
        self.false_color_image = sensor_msgs.msg.Image()
    else:
      self.transform = geometry_msgs.msg.TransformStamped()
      self.platform = ''
      self.image = sensor_msgs.msg.Image()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6IB3I().pack(_x.info.binning_x, _x.info.binning_y, _x.info.roi.x_offset, _x.info.roi.y_offset, _x.info.roi.height, _x.info.roi.width, _x.info.roi.do_rectify, _x.labels.header.seq, _x.labels.header.stamp.secs, _x.labels.header.stamp.nsecs))
      _x = self.labels.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.labels.height, _x.labels.width))
      _x = self.labels.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.labels.is_bigendian, _x.labels.step))
      _x = self.labels.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.false_color_image.header.seq, _x.false_color_image.header.stamp.secs, _x.false_color_image.header.stamp.nsecs))
      _x = self.false_color_image.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.false_color_image.height, _x.false_color_image.width))
      _x = self.false_color_image.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.false_color_image.is_bigendian, _x.false_color_image.step))
      _x = self.false_color_image.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(struct.pack('<I%sB'%length, length, *_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.info.binning_x, _x.info.binning_y, _x.info.roi.x_offset, _x.info.roi.y_offset, _x.info.roi.height, _x.info.roi.width, _x.info.roi.do_rectify, _x.labels.header.seq, _x.labels.header.stamp.secs, _x.labels.header.stamp.nsecs,) = _get_struct_6IB3I().unpack(str[start:end])
      ...
      if python3:
        self.labels.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.labels.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.labels.height, _x.labels.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.labels.encoding = str[start:end].decode('utf-8')
      else:
        self.labels.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.labels.is_bigendian, _x.labels.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.labels.data = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.false_color_image.header.seq, _x.false_color_image.header.stamp.secs, _x.false_color_image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.false_color_image.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.false_color_image.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.false_color_image.height, _x.false_color_image.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.false_color_image.encoding = str[start:end].decode('utf-8')
      else:
        self.false_color_image.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.false_color_image.is_bigendian, _x.false_color_image.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.false_color_image.data = str[start:end]
      return self
