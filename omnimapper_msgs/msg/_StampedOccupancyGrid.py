...
"""autogenerated by genpy from omnimapper_msgs/StampedOccupancyGrid.msg. Do not edit."""
import sys
...
class StampedOccupancyGrid(genpy.Message):
  _md5sum = "a4911f2a20efb20f926e1d477522eee0"
  _type = "omnimapper_msgs/StampedOccupancyGrid"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# The platform source of this occupancy grid
string platform
...
float64 w
"""
  __slots__ = ['platform','map']
  _slot_types = ['string','nav_msgs/OccupancyGrid']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StampedOccupancyGrid, self).__init__(*args, **kwds)
