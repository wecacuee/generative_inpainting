...
"""autogenerated by genpy from omnimapper_msgs/PoseGraphNode.msg. Do not edit."""
import sys
...
class PoseGraphNode(genpy.Message):
  _md5sum = "dd1271c1179e475e52a0cfeabf66749a"
  _type = "omnimapper_msgs/PoseGraphNode"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# A time/platform stamped pose with identifying frame
time stamp
string platform
...
float64 w
"""
  __slots__ = ['stamp','platform','child_frame_id','pose']
  _slot_types = ['time','string','string','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       stamp,platform,child_frame_id,pose
