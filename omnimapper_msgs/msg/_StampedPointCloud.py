...
"""autogenerated by genpy from omnimapper_msgs/StampedPointCloud.msg. Do not edit."""
import sys
...
class StampedPointCloud(genpy.Message):
  _md5sum = "1b03a68f5ae3a16c772cba1df26856e5"
  _type = "omnimapper_msgs/StampedPointCloud"
...
"""
  __slots__ = ['transform','platform','cloud']
  _slot_types = ['geometry_msgs/TransformStamped','string','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StampedPointCloud, self).__init__(*args, **kwds)
